-- Master data for the listings calculation feature.
-- Values are common-case approximations as of 2026-05. Operators should verify
-- current rates against each provider's official page and update via UPDATE
-- statements; this file uses ON CONFLICT DO NOTHING so re-runs are no-ops.
...
-- Use a CTE to look up the surrogate IDs by name so this migration is robust
-- against re-ordering or partial re-runs.
----------------------------------------------------------------------
